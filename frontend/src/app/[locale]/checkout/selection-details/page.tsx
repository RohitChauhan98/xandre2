...
const choosePay = [
  {
    id: 1,
    title: "Pay in full",
    description: "Pay the total of ¥56,029 now and you’re all set."
  },
  {
    id: 2,
    title: "Group pay",
    description: "Pay your share now and split the rest with friends. Everyone will have 48 hours to pay or your reservation will be cancelled and refunded to you. To keep your booking, pay for the trip at any time during the 48 hour window.",
  },
        ...
        <div className='w-[1280px] flex gap-5 pt-10 mb-10'>
          ...
          <div className='w-[954px]'>
            <form>
              ...
              <h3 className='text-h3 font-semibold leading-[24px]'>Choose how to pay</h3>
              <div className='flex gap-3 mt-6 flex-wrap'>
                <section className='flex gap-4 items-center'>
                    {
                        choosePay.map(option=>(
                        <div className='flex flex-col w-1/2'>
                            <label className='flex items-center w-full gap-3 cursor-pointer'>
                                <input type="radio" name='pay' className='appearance-none self-start h-5 w-5 border border-input-200 rounded-full checked:bg-lion-200 checked:border-lion-200 focus:outline-none transition duration-200'/>
                                <div className='flex flex-1 flex-col gap-1 flex-wrap'>
                                    <p className='text-[15px] leading-[22px]'>{option.title}</p>
                                    <p className='text-[13.5px] text-alice-blue-400 leading-[18px]'>{option.description}</p>
                                </div>
                            </label>
                        </div>
                        ))
                ...
                <section className='w-full flex gap-10'>
                        ...
                        {addToStayOptions.map((option,index)=>(
                          <div className='flex flex-col'>
                            <label className='flex px-6 gap-3 items-center cursor-pointer'>
                              <input type="radio" name='who' className='appearance-none self-start h-5 w-5 border border-input-200 rounded-full checked:bg-lion-200 checked:border-lion-200 focus:outline-none transition duration-200'/>
                 ...
                 <section className='min-h-[246px] w-[628px] flex flex-col gap-3 mt-4'>
                    ...
                    <label className='flex gap-3 items-center cursor-pointer w-fit'>
                      <input type="checkbox" name='who' className='appearance-none self-start h-5 w-5 border border-input-200 rounded-full checked:bg-lion-200 checked:border-lion-200 focus:outline-none transition duration-200'/>
                ...
                <ButtonLightGradient background ="bg-white" className='h-[56px] w-[360px] mt-12 text-[18px] font-semibold' >Next: Final step</ButtonLightGradient>
